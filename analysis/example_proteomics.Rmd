...
For this report I will be using proteomics data from Mulvey et al 2021 (PMID: 34599159),
who looked at the effect of LPS on THP-1 cell lines.
Although in this paper they looked at numerous timepoints, I will be looking only at the 24hr time
point where the number of significantly differentially expressed proteins was the greatest.
The data were obtained from Supplementary Table 1 and saved to the /data folder.

```{r,fetch}

def <- read.table("../data/lps_24h.tsv",sep="\t",header=TRUE)
