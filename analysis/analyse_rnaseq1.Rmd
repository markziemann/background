...
colMeans(itxlenmx,na.rm=TRUE) / colMeans(speclenmx,na.rm=TRUE)

mean( ( colMeans(speclenmx,na.rm=TRUE) - colMeans(itxlenmx,na.rm=TRUE) ) / colMeans(itxlenmx,na.rm=TRUE) )
