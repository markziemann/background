...
library(beeswarm)
boxplot(unsl,horizontal=TRUE,las=1,col=c("lightblue","pink"),cex=0,xlab="no. significant sets FDR<0.05")
beeswarm(unsl,horizontal=TRUE,add=TRUE,col=c("blue","red"),pch=19,cex=0.6)
