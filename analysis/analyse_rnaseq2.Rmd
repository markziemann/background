...
library(reshape2)
res2a <- as.matrix(acast(res1, Var1~Var2, fun.aggregate = sum, value.var="nsig_bad"))
rownames(res2a) <- gsub("bulkrna","d",rownames(res2a))
rownames(res2a) <- gsub(".Rds"," original",rownames(res2a))

res2b <- as.matrix(acast(res1, Var1~Var2, fun.aggregate = sum, value.var="nsig_good"))
