...
gsets <- randomGeneSets(a,setsize=20,nsets=200)
...
legend("bottomleft", inset=.02, title="tool",
   c("clusterprofiler","fora","fgsea"), col=c("black","red","blue"), horiz=FALSE, cex=1.2, pch=19,lwd=2)
