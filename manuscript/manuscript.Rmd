...
approach to a previously published dataset derived from 37 lung cancer patients, having tumor and normal
...
After reading them into R, we noticed some gene names converted to dates [@Abeysooriya2021-qt], so we
...
differentially expressed in tumor compared to normal tissue.
...
in the full set of 27 patients using fgsea and fora respectively.
...
Secondly, many popular ORA tools listed in Table 1 do not provide enrichment scores in their
