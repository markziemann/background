...
All analyses were undertaken with R v4.4.0.
...
As anticipated, mitigating the background problem improved recall (by 1.6%), however it caused
a similar-sized decrease in precision.
Addressing the FDR problem improved precison by 9.6%, but the recall dropped by 8.5%.
Addressing both problems improved precision by 8.2% but decreased recall by 5.6%.
...
fgsea recorded precision of 0.937, similar to the ORA methods, but recall was far superior,
with fgsea scoring 22.4% higher than default clusterProfiler and 28% higher than fora.
As a result, fgsea's overall accuracy as defined by F1 index was 21.2% higher than fora and
18.4% higher than default clusterProfiler.

When looking at the accuracy profile at different levels of added noise (**Figure 3B**), we
see that ORA techniques have superior precision when the added noise is low (<0.2), but the
precision of ORA techniques drops at higher levels of added noise.
