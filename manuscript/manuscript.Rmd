...
biological changes, and has become one of the most popular methods in bioinformatics.
...
by some statistical test for enrichment of gene categories at either extreme of the
ranked list.
...
Of these two methods, FCS is reported to be the most accurate, while ORA seems to be the
most popular.
...
A survey of articles published in 2019 showed that seven of the top eight most popular
methods were based on ORA.
